   		...
   		<div class="row">
      		...
      		<div class="box-body">
                  ...
                  <div class="col-md-4" style="text-align: center;">
                    <img style="max-width:300px; width:100%; height:auto;" src="../../assets/img/Kota Bandar Lampung.png"><br>
                    <?php  
                  ...
                  <div class="col-md-8">
                    ...
                    <div style="font-size: 15pt; font-weight: 500;"><p>Selamat datang di <a href="#" style="text-decoration:none"><strong>Web Aplikasi Pelayanan Surat Administrasi Online.</strong></a></p></div><br><br><br>
                  </div>
        				</div>
              </form>
        		</div>
