	...
	<navbar class="navbar navbar-expand-lg navbar-dark bg-transparent">
	  	...
	  	<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
	    	<ul class="navbar-nav ml-auto mt-lg-3 mr-5 position-relative text-right">
	      		...
	      		<li class="nav-item">
	        		<a class="nav-link text-dark" href="surat/">BUAT SURAT</a>
	      		</li>
	      		<li class="nav-item">
	        		<a class="nav-link text-dark" href="tentang/">TENTANG <b>MAILFLOW</b></a>
	      		</li>
...
<div class="container" style="max-height:cover; padding-top:50px; padding-bottom:120px" align="center">
	<img src="assets/img/Kota Bandar Lampung.png"><hr>
	<a class="text-dark" style="font-size:18pt"><strong>WEB APLIKASI PELAYANAN SURAT ADMINISTRASI</strong></a><br>
	<?php  
	...
	<a class="text-dark" style="font-size:15pt; text-transform: uppercase;"><strong><?php echo $row['kota']; ?></strong></a><hr>
	<?php  
		}
	?>
	<a href="surat/" class="btn btn-outline-dark" style="font-size:15pt"><i class="fas fa-envelope"></i> BUAT SURAT</a>
</div>
</body>
</html>
