    ...
    <div style="max-height:cover; padding-top:30px; padding-bottom:60px; position:relative; min-height: 100%;">
        ...
        <div class="row">
            <div class="col-sm-3 mt-4">
                <div class="card">
                    <img src="../assets/img/Kota Bandar Lampung.png" class="card-img-top" alt="...">
                    <div class="card-body text-center">
                        <h5 class="card-title">SURAT KETERANGAN</h5><br><br>
                        <a href="surat_keterangan/" class="btn btn-info btn-custom">BUAT SURAT</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-3 mt-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <a href="surat_keterangan_berkelakuan_baik/" class="btn btn-info btn-custom">BUAT SURAT</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-3 mt-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <a href="surat_keterangan_domisili/" class="btn btn-info btn-custom">BUAT SURAT</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-3 mt-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <a href="surat_keterangan_kepemilikan_kendaraan_bermotor/" class="btn btn-info btn-custom">BUAT SURAT</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-3 mt-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <a href="surat_keterangan_perhiasan/" class="btn btn-info btn-custom">BUAT SURAT</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-3 mt-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <a href="surat_keterangan_usaha/" class="btn btn-info btn-custom">BUAT SURAT</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-3 mt-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <a href="surat_lapor_hajatan/" class="btn btn-info btn-custom">BUAT SURAT</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-3 mt-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <a href="surat_pengantar_skck/" class="btn btn-info btn-custom">BUAT SURAT</a>
                    </div>
                </div>
            </div>
        </div>
